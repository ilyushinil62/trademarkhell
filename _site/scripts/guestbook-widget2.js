...
const s_stylePath = '/css/comment-widget-dark2.css?=v2.90';
const s_formId = '1FAIpQLSeHVtTUT_OW1vvSE-6nH8Cc0cuoUiJ8H7FAKIqk0qZqeygn-Q';
const s_nameId = '108693668';
const s_websiteId = '1955006000';
const s_textId = '1513513794';
const s_pageId = '1435211139';
const s_replyId = '2071701667';
const s_sheetId = '12K0oQzJno2zz63RWBy5T6PMIHeD9Bo08uQwTGAeVEwI';
...
const s_maxLength = 3000; // The max character length of a comment
...
const s_widgetTitle = 'praise this awesome article';
const s_nameFieldLabel = 'alias';
const s_websiteFieldLabel = 'site';
const s_textFieldLabel = '';
const s_submitButtonLabel = 'send it in';
const s_loadingText = 'loading...';
const s_noCommentsText = 'nothin here.';
const s_closedCommentsText = 'comments closed, sorry mate';
